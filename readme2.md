...
├── colab_requirements_2025_11.txt  # Minimal dependencies for Google Colab
...
- Optionally run the dataset inspection and cleaning notebook
...
- Open `evaluation_notebook.ipynb`
- Load trained checkpoints
- Compute validation and test metrics
- Compare runs across datasets and training strategies
